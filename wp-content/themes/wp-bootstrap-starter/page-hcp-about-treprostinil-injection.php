...
<div id="trep-injection">
	...
	<div class="row secondary-nav">
		<div class="col-lg blue-nav trep-injection-nav hcp-blue-nav">
			...
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>/hcp/" class="trep-link">About Treprostinil Injection&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;</a>
	...
	<div class="row body-head">
		<div class="col-lg">
			<h1>About Treprostinil Injection</h1>
			<div class="orange-line"></div>
		</div>
	</div>
	<div class="row body-copy-ti">
		<div class="col-sm-8 col-xs-12">
			<h3>The first fully substitutable generic for Remodulin<sup>&reg;</sup> (treprostinil) Injection<sup>1,2</sup></h3>
			<p>Available to treat patients with pulmonary arterial hypertension (PAH; WHO Group 1), Treprostinil Injection offers a known treatment option at a lower price.<sup>1,3</sup>* Treprostinil Injection is the <b>first</b> FDA-approved generic for Remodulin<sup>&reg;</sup>.<sup>1,2</sup></p>
			<h3>A therapeutic equivalent for a known molecule<sup>2-7</sup></h3>
			<h4>Treprostinil Injection is therapeutically equivalent to Remodulin<sup>&reg; 1,3,4,7</sup></h4>
			<div class="list-padding">
				<p><span style="color: #22647e;">&bull;</span> Same active ingredient</p>
				<p><span style="color: #22647e;">&bull;</span> Same strengths</p>
				<p><span style="color: #22647e;">&bull;</span> Same dosage forms</p>
				<br>
			</div>
			<h4>Treprostinil Injection is qualitatively and quantitatively equivalent to Remodulin<sup>&reg; 1-4,7</sup></h4>
			<div class="list-padding">
				<p><span style="color: #22647e;">&bull;</span> Same inactive ingredients</p>
				<p><span style="color: #22647e;">&bull;</span> Quantitatively the same inactive ingredient amounts</p>
				<br>
			</div>
			<p class="small move-left">*Sources: AnalySource Online and Red Book Online.</p>
		</div>
	...
	<div class="row">
		<div class="col-lg-12 center-img">
			<h3 class="h3-spacing mobile-padding">&nbsp;&nbsp;&nbsp;Therapeutic Equivalence<sup>1,3,4</sup></h3>
			<img src="<?php echo get_template_directory_uri() . '/images/chart1.png'; ?>" class="chart1" alt="Therapeutic Equivalence Chart">
		</div>
		<div class="col-lg-12 center-img">
			<h3 class="h3-spacing">&nbsp;&nbsp;&nbsp;Therapeutic Equivalence: Formulation<sup>1,3,4</sup></h3>
			<img src="<?php echo get_template_directory_uri() . '/images/chart2.png'; ?>" class="chart2" alt="Therapeutic Equivalence: Formulation Chart">
			<p class="small move-left no-margin-bottom"><sup>&dagger;</sup>Treprostinil Injection and Remodulin<sup>&reg;</sup> are both available in strengths of 1, 2.5, 5, and 10 mg/mL.<sup>3,4</sup></p>
			<p class="small move-left no-margin"><sup>&#8225;</sup>Each mL also contains 5.3 mg sodium chloride (except for the 10-mg/mL strength, which contains 4.0 mg sodium chloride).<sup>3,4</sup></p>
			<br>
		</div>
	</div>
	<div class="row partnership">
		<div class="col-xs-12 col-sm-7 text">
			<img src="<?php echo get_template_directory_uri() . '/images/partnership.png'; ?>" class="partnership" alt="A partnership focused on PAH">
			<br><br>
			<p class="blue bigger">Supplied by <span style="color: #1a62ad; font-weight: 700;">Sandoz</span>, a division of Novartis</p>
			<p><span style="color: #22647e;">&bull;</span> A global leader in generics and biosimilar medicines</p>
			<p><span style="color: #22647e;">&bull;</span> With a supply chain providing <b>trusted quality and supply</b></p>
			<br>
			<p class="blue bigger">Commercial oversight and market support provided by <span style="color: #f7961d; font-weight: 700;">Rare</span><span style="font-weight: 700;">Gen</span></p>
			<p><span style="color: #22647e;">&bull;</span> A team with <b>deep experience in PAH</b></p>
		</div>
		<div class="col-xs-12 col-sm-5 handshake mobile-center">
			<img src="<?php echo get_template_directory_uri() . '/images/handshake.png'; ?>" class="handshake" alt="handshake">
		</div>
	</div>
	<div class="row">
		<div class="col-lg-5 offset-lg-1 blue-cta cta">
			<br><br>
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>/hcp-getting-started/"><p class="bigger">Learn more about getting<br>started with Treprostinil Injection.</p></a>
		</div>
		<div class="col-lg-5 gray-cta cta">
			<br>
			<span class="hidden-xs"><br></span>
			<a href="<?php echo get_template_directory_uri() . '/assets/trep-patient-brochure.pdf'; ?>" target="_blank"><p class="bigger">Download a brochure for<br>patients about Treprostinil Injection.</p></a>
		</div>
	</div>
	<div class="row mobile-padding">
		<div class="col-lg-12">
			<p class="small"><b>References: 1.</b> Data on file, Sandoz Inc. <b>2.</b> Drugs@FDA: FDA Approved Drug Products. https://www.accessdata.fda.gov/scripts/cder/daf/index.cfm?event=overview.process&ApplNo=203649. Accessed October 16, 2018. <b>3.</b> Treprostinil Injection [package insert]. Princeton, NJ: Sandoz Inc; 2018. <b>4.</b> Remodulin [package insert]. Research Triangle Park, NC: United Therapeutics Corp; 2018. <b>5.</b> Orenitram [package insert]. Research Triangle Park, NC: United Therapeutics Corp; 2017. <b>6.</b> Tyvaso [package insert]. Research Triangle Park, NC: United Therapeutics Corp; 2017. <b>7.</b> Office of Generic Drugs. <em>Orange Book: Approved Drug Products with Therapeutic Equivalence Evaluations</em>. 38th ed. Rockville, MD: U.S. Dept. of Health and Human Services, Food and Drug Administration, Center for Drug Evaluation and Research, Office of Pharmaceutical Science, Office of Generic Drugs; 2018:iv-ADB1. https://www.fda.gov/downloads/drugs/<span class="show-xs"> </span>developmentapprovalprocess/ucm071436.pdf. Accessed October 16, 2018. </p>
		</div>
	</div>
	<div class="row isi">
		<div class="col-lg-12">
